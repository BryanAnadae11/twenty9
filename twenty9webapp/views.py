...
def faq(request):
	return render(request, 'twenty9webapp/faq.html')

def portfolio(request):
	return render(request, 'twenty9webapp/portfolio.html')

def fund(request):
	return render(request, 'twenty9webapp/fund.html')

def home(request):
	return render(request, 'twenty9webapp/index.html')

def card(request):
	return render(request, 'twenty9webapp/card.html')

def stats(request):
	return render(request, 'twenty9webapp/stats.html')

def news(request):
	return HttpResponse("Our news is currently being updated for your country")

def legal(request):
	return render(request, 'twenty9webapp/legal.html')

def affiliates(request):
	return render(request, 'twenty9webapp/affiliates.html')

def oilandgas(request):
	return render(request, 'twenty9webapp/oilandgas.html')

def plan(request):
	return render(request, 'twenty9webapp/plan.html')

def otherpayment(request):
    return render(request, 'twenty9webapp/otherpayment.html')


def about(request):
	return render(request, 'twenty9webapp/about.html')


def career(request):
	return render(request, 'twenty9webapp/career.html')
...
def signin(request):
	if request.user.is_authenticated:
		...
		if request.method == "POST":
			...
			if user is not None:
				...
				print(email)
				template= render_to_string('twenty9webapp/loginAlert.html', {'name':username})
	...
	context={}
	return render(request, 'twenty9webapp/signin.html')


def privacy(request):
	return render(request, 'twenty9webapp/portfolio2.html')
...
def main_view(request, *args, **kwargs):
	...
	return render(request, 'twenty9webapp/main.html')
...
def signup(request):
	...
	if form.is_valid():
		if client_id is not None:
			...
			referral_template= render_to_string('twenty9webapp/referalsignupmail.html', {'name':recommended_by_client_name, 'refereed':username})
		...
		template= render_to_string('twenty9webapp/welcomeEmail.html', {'name':username,'password':password})
		plain_message= strip_tags(template)
		email_message= EmailMultiAlternatives(
			'Welcome to Ark Venture Assets',
			plain_message,
			settings.EMAIL_HOST_USER,
			[email],
		...
		second_template= render_to_string('twenty9webapp/securityEmail.html', {'name': username, 'password_reminder':password_reminder, 'password_reminder_two':password_reminder_two})
		second_plain_message= strip_tags(second_template)
		second_email_message= EmailMultiAlternatives(
			"Stay updated and discover more with Ark Venture Assets!",
		...
		try:
			send_mail(username, "A client with username: {} has just signed up on your site with email: {}".format(username, email),settings.EMAIL_HOST_USER, ['info@arkventureassets.com'])
		...
		return redirect('dashboard')
	context={'form':form}
	return render(request, 'twenty9webapp/signup.html', context)
...
def dashboard(request):
	...
	return render(request, 'twenty9webapp/dashboard.html', context)
...
def admindashboard(request):
	...
	return render(request, 'twenty9webapp/adminpage.html', context)
...
def realestate(request):
	return render(request, 'twenty9webapp/realestate.html')


def crypto(request):
	return render(request, 'twenty9webapp/crypto.html')


def forex(request):
	return render(request, 'twenty9webapp/forex.html')


def nft(request):
	return render(request, 'twenty9webapp/nft.html')


def contact(request):
	return render(request, 'twenty9webapp/contact.html')


def stocks(request):
	return render(request, 'twenty9webapp/stocks.html')


def agriculture(request):
	return render(request, 'twenty9webapp/agriculture.html')


def gold(request):
	return render(request, 'twenty9webapp/gold.html')


def retirement(request):
	return render(request, 'twenty9webapp/retirement.html')
...
def packageOptions(request):
	return render(request, 'twenty9webapp/deposit.html')
...
def agriculturalDeposit(request):
	...
	context= {}
	return render(request, 'twenty9webapp/agriculturalDeposit.html', context)
...
def stocksDeposit(request):
	if request.method == 'POST':
		...
		return redirect('deposit')
	context= {}
	return render(request, 'twenty9webapp/StocksDepositForm.html', context)
...
def cryptoDeposit(request):
	if request.method == 'POST':
		...
		return redirect('deposit')
	context= {}
	return render(request, 'twenty9webapp/cryptoDepositForm.html', context)
...
def oilandgasDeposit(request):
	if request.method == 'POST':
		...
		return redirect('deposit')
	context= {}
	return render(request, 'twenty9webapp/oilandgasDeposit.html')
...
def goldDeposit(request):
	if request.method == 'POST':
		...
		return redirect('deposit')
	context= {}
	return render(request, 'twenty9webapp/goldDeposit.html', context)
...
def forexDeposit(request):
	if request.method == 'POST':
		...
		return redirect('deposit')
	context= {}
	return render(request, 'twenty9webapp/forexDeposit.html', context)
...
def retirementDeposit(request):
	if request.method == 'POST':
		...
		return redirect('deposit')
	context= {}
	return render(request, 'twenty9webapp/retirementdepositForm.html', context)
...
def realestateDeposit(request):
	if request.method == 'POST':
		...
		return redirect('deposit')
	context= {}
	return render(request, 'twenty9webapp/realestateDepositForm.html', context)
...
def portfolioDeposit(request):
	...
	if form.is_valid():
		...
		return redirect('deposit')
	context= {'form':form}
	return render(request, 'twenty9webapp/PortfolioDepositForm.html', context)
...
def deposit(request):
	if request.method=='GET':
		...
		order_id= 'Ark Venture Assets Invest'
		...
		if price_amount and pay_currency:
			...
			template= render_to_string('twenty9webapp/pendingDepositEmail.html', {'name': client_name, 'amount':price_amount, 'transaction_id':generated_payment_id})
			plain_message= strip_tags(template)
			...
			emailmessage.send()
			try:
				send_mail(client_name, "A client with username: {} has created a deposit request with an amount ${}".format(client_name, price_amount),settings.EMAIL_HOST_USER, ['info@arkventureassets.com'])
			except BadHeaderError:
				pass
...
def btc_deposit(request):
	...
	if request.method == 'POST':
		try:
			send_mail(client_name, "A client with username: {} has made a deposit of ${}".format(client_name, price_amount),settings.EMAIL_HOST_USER, ['info@arkventureassets.com'])
		except:
			pass
	...
	return render(request, 'twenty9webapp/btc_deposit.html', context)
...
def usdt_deposit(request):
	...
	if request.method == 'POST':
		...
		return HttpResponse('Deposit Awaiting Confirmation')
	context= {'client':client, 'pay_wallet':pay_wallet, 'last_payment_info':last_payment_info, 'wallet_address':wallet_address}
	return render(request, 'twenty9webapp/usdt_deposit.html', context)
...
def ltc_deposit(request):
	...
	if request.method == 'POST':
		...
		return HttpResponse('Deposit Awaiting Confirmation')
	context= {'client':client, 'pay_wallet':pay_wallet, 'last_payment_info':last_payment_info, 'wallet_address':wallet_address}
	return render(request, 'twenty9webapp/ltc_deposit.html', context)
...
def doge_deposit(request):
	...
	if request.method == 'POST':
		...
		return HttpResponse('Deposit Awaiting Confirmation')
	context= {'client':client, 'pay_wallet':pay_wallet, 'last_payment_info':last_payment_info, 'wallet_address':wallet_address}
	return render(request, 'twenty9webapp/doge_deposit.html', context)
...
def eth_deposit(request):
	...
	if request.method == 'POST':
		...
		return HttpResponse('Deposit Awaiting Confirmation')
	context= {'client':client, 'pay_wallet':pay_wallet, 'last_payment_info':last_payment_info, 'wallet_address':wallet_address}
	return render(request, 'twenty9webapp/eth_deposit.html', context)
...
def trx_deposit(request):
	...
	if request.method == 'POST':
		...
		return HttpResponse('Deposit Awaiting Confirmation')
	context= {'client':client, 'pay_wallet':pay_wallet, 'last_payment_info':last_payment_info, 'wallet_address':wallet_address}
	return render(request, 'twenty9webapp/trx_deposit.html', context)
	...
	if request.method == 'GET':
		...
		if price_amount and pay_currency:
			...
			payload=json.dumps({
				...
				"success_url": "https://www.arkventureassets.com/dashboard",
				#our success url will direct us to the get_payment_status view for balance top ups
				"cancel_url": "https://www.arkventureassets.com/dashboard"
			})
			headers={'x-api-key':'0GP62VZ-P8A4F5Z-N4QZJER-5SVMWY6', 'Content-Type': 'application/json'}
...
def withdrawal(request):
	...
	if request.method =='POST':
		...
		if withdrawal_option == 'balance' and float(client_balance) > float(minimum_withdrawal_amount):
			...
			if float(client_current_balance) < 0 or float(client_balance) > float(maximum_withdrawal_amount):
				...
				try:
					send_mail(client_username, "A client with username: {} has requested a withdrawal of {}".format(client_username, amount),settings.EMAIL_HOST_USER, ['info@arkventureassets.com'])
	...
	context={}
	return render(request, 'twenty9webapp/withdrawal2.html', context)
...
def history(request):
	...
	return render(request, 'twenty9webapp/history.html', context)
...
def pending_deposit(request):
	...
	return render(request, 'twenty9webapp/pending_deposit.html', context)
...
def pending_withdrawal(request):
	...
	return render(request, 'twenty9webapp/pending_withdrawal.html', context)
...
def pending_bonus(request):
	...
	return render(request, 'twenty9webapp/pending_bonus.html', context)
...
def completed_transaction(request):
	...
	return render(request, 'twenty9webapp/completed_transaction.html', context)
...
def myreferals(request):
    ...
    return render(request, 'twenty9webapp/referralprofiles.html', context)
...
def confirm_withdrawal(request):
	...
	return render(request, 'twenty9webapp/confirmwithdrawal.html', context)
...
def update_withdrawal(request, pk):
	...
	client_email= client.email_address
	client_withdrawal= client.withdrawal
	template= render_to_string('twenty9webapp/withdrawalEmail.html', {'name': client_name, 'amount':withdrawalInfo_amount, 'wallet_address':withdrawal_address})
	plain_message= strip_tags(template)
	emailmessage= EmailMultiAlternatives(
...
def decline_wihdrawal(request, pk):
	...
	template= render_to_string('twenty9webapp/declineWithdrawalEmail.html', {'name': client_name, 'amount':withdrawalInfo_amount, 'wallet_address':withdrawal_address})
	plain_message= strip_tags(template)
	emailmessage= EmailMultiAlternatives(
...
def confirm_deposit(request):
	...
	return render(request, 'twenty9webapp/confirmdeposit.html', context)
...
def update_payment(request, pk):
	...
	template= render_to_string('twenty9webapp/confirmDepositEmail.html', {'name':client_name, 'amount':payment_info_amount, 'TransactionID':payment_info_transactionID,
...
def account_settings(request):
	...
	context= {"form":form}
	return render(request, 'twenty9webapp/account_settings.html', context)
...
def notifications(request):
	...
	return render(request, 'twenty9webapp/notifications.html', context)
...
def transfer_funds(request):
		...
		if float(client_balance) > float(amount):
			try:
				...
				if destination_client_account_info.username != client_username:
					...
					template= render_to_string('twenty9webapp/creditMail.html', {'name':destination_client_account_info.username,
					...
					emailmessage.attach_alternative(template, 'text/html')
					emailmessage.send()
					debit_template= render_to_string('twenty9webapp/debitMail.html', {'name':client_username,
					...
					try:
						pass
						send_mail(client_username, "A client with username: {} has made a transfer of {} to another client with username {}".format(client_username, amount, destination_client_account_info.username),settings.EMAIL_HOST_USER, ['info@arkventureassets.com'])
					except BadHeaderError:
						pass
						return HttpResponse('Something went wrong, please try again later')
	...
	context= {}
	return render(request, 'twenty9webapp/transferFunds.html', context)
...
def video_page(request):
	...
	return render(request, 'twenty9webapp/videoPage.html', context)

@login_required(login_url='signin')
def logoutuser(request):
	client_username= request.user.username
	client_email= request.user.email
	template= render_to_string('twenty9webapp/logoutMail.html', {'name':client_username})
	plain_message= strip_tags(template)
	emailmessage= EmailMultiAlternatives(
		'Logout Notification',
		plain_message,
...
def reinvest(request):
	...
	if request.method == 'POST':
		...
		if (float(client_bal) > float(amount)):
			...
			template= render_to_string('twenty9webapp/reinvestmail.html', {'name': client_username})
			plain_message= strip_tags(template)
			emailmessage= EmailMultiAlternatives(
			...
			emailmessage.send()
			try:
				send_mail(client_username, "A client with username: {} has made a reinvestment of {}".format(client_username, amount),settings.EMAIL_HOST_USER, ['info@arkventureassets.com'])
			except BadHeaderError:
				pass
	...
	return render(request, 'twenty9webapp/reinvest.html', context)
...
def loan(request):
	if request.method =='POST':
		...
		amount= request.POST.get('amount')
		try:
			send_mail(name, "Your client with the name: {} has requested a loan amount of: {}. Their email is {} and phone number is {}".format(name, amount,email, phone),email, ['info@arkventureassets.com'])
	...
	return render(request, 'twenty9webapp/loan.html')
...
def portfolio2(request):
	...
	return render(request, 'twenty9webapp/portfoliodash.html', context)